...
description 'LXRCore v3 craft: recipes on the catalog at stations, trades with levels and mastery, a server-timed queue'
version '3.0.0'
repository 'https://github.com/LXRCore/lxr-craft'
